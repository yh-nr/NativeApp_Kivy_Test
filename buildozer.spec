...
# requirements = Python3, kivy==2.2.0, cython, japanize_kivy, pyjnius, pillow
requirements = Python3, kivy==2.2.0, cython, japanize_kivy, pyjnius, plyer
